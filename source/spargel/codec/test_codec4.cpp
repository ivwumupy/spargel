...
namespace {
    ...
    static_assert(Encoder4<ErrorEncoder<bool>>);
    static_assert(Decoder4<ErrorDecoder<bool>>);
    ...
    static_assert(Encoder4<VectorEncoder<NullCodec>>);
    static_assert(Decoder4<VectorDecoder<NullCodec>>);
    static_assert(Codec<VectorCodec<NullCodec>>);

    static_assert(Encoder4<VectorEncoder<VectorEncoder<NullCodec>>>);
    static_assert(Decoder4<VectorDecoder<VectorDecoder<NullCodec>>>);
    ...
    static_assert(Encoder4<decltype(Student::encoder())>);
    static_assert(Decoder4<decltype(Student::decoder())>);
