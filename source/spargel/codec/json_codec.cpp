...
namespace spargel::codec {
    ...
    base::Optional<JsonDecodeError> JsonDecodeBackend::getNull(const json::JsonValue& data) {
    ...
    base::Either<bool, JsonDecodeError> JsonDecodeBackend::getBoolean(const json::JsonValue& data) {
    ...
    base::Either<u8, JsonDecodeError> JsonDecodeBackend::getU8(const json::JsonValue& data) {
    ...
    base::Either<i8, JsonDecodeError> JsonDecodeBackend::getI8(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<u16, JsonDecodeError> JsonDecodeBackend::getU16(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<i16, JsonDecodeError> JsonDecodeBackend::getI16(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<u32, JsonDecodeError> JsonDecodeBackend::getU32(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<i32, JsonDecodeError> JsonDecodeBackend::getI32(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<u64, JsonDecodeError> JsonDecodeBackend::getU64(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<i64, JsonDecodeError> JsonDecodeBackend::getI64(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<f32, JsonDecodeError> JsonDecodeBackend::getF32(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<f64, JsonDecodeError> JsonDecodeBackend::getF64(const json::JsonValue& data) {
        if (data.type == json::JsonValueType::number) {
    ...
    base::Either<base::vector<json::JsonValue>, JsonDecodeError> JsonDecodeBackend::getArray(
        const json::JsonValue& data) {
    ...
    base::Either<base::Optional<json::JsonValue>, JsonDecodeError> JsonDecodeBackend::getMember(
        const json::JsonValue& data, base::StringView key) {
        if (data.type == json::JsonValueType::object) {
            auto* ptr = data.object.members.get(key);
            return base::Left(ptr != nullptr ? base::makeOptional<json::JsonValue>(*ptr)
                                             : base::nullopt);
        } else {
